...
/**
 * Extends the ToolBar; puts all of the customization and layout options into one file where I can find it easily
 * @author Spencer Gannon
 */
public class CleanToolBar extends ToolBar{
    ...
    public CleanToolBar(){
        ...
        try {
            ...
            Logger.getLogger(CleanToolBar.class.getName()).log(Level.SEVERE, null, ex);
        }
